...
int main()
{
    ...
    // 2. Iterator
    map<string,int> :: iterator it = m.begin(); // it points to first element of map
    while(it != m.end()){ // it points to last element of map
        cout<<it->first<<" "<<it->second<<endl;
        it++; // it points to next element of map
    }
